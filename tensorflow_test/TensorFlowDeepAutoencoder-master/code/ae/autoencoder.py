...
from utils.data import read_data_sets, fill_feed_dict, ExtractData
...
def main_unsupervised():
  with tf.Graph().as_default() as g:
    ...
    ae_shape = [FLAGS.number_genes] + ae_hidden_shapes + [FLAGS.num_classes]
        ...
        for step in xrange(FLAGS.pretraining_epochs * num_train):
          ...
          if step % 100 == 0:
            ...
            output = "| {0:>13} | {1:13.4f} | Layer {2} | Epoch {3}  |"\
                     .format(step, loss_value, n, step // num_train + 1)#// means integer divided
